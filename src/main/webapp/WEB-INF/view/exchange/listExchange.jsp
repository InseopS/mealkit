        ...
        <div class='row'>
            <div class='col'>
                <nav class='d-flex mt-3 justify-content-center'>
                    <button type='button' class='btn flex-fill btn-outline-dark mr-4' onclick='location.href="../order/list"'>주문내역</button>
                    <button type='button' class='btn flex-fill mr-4 bg-dark text-white' onclick='location.href="../exchange/list"'>교환내역</button>
                    <button type='button' class='btn flex-fill  ml-0.5 btn-outline-dark' onclick='location.href="../return/list"'>반품내역</button>
                </nav>
